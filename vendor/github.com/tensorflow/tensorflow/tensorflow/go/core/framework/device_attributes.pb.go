...
func (*InterconnectLink) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*LocalLinks) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*DeviceLocality) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*DeviceAttributes) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{3} }
