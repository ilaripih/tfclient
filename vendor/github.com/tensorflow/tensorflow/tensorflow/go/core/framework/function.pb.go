...
type FunctionDef struct {
	...
	ArgAttr map[uint32]*FunctionDef_ArgAttrs `protobuf:"bytes,7,rep,name=arg_attr,json=argAttr" json:"arg_attr,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	ControlRet map[string]string `protobuf:"bytes,6,rep,name=control_ret,json=controlRet" json:"control_ret,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
type FunctionDef_ArgAttrs struct {
	Attr map[string]*AttrValue `protobuf:"bytes,1,rep,name=attr" json:"attr,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*FunctionDef_ArgAttrs) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1, 1} }
