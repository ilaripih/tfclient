...
func (*AllocationRecord) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*AllocatorMemoryUsed) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func (*NodeOutput) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{2} }
...
func (*MemoryStats) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{3} }
...
type NodeExecStats struct {
	...
	AllStartNanos    int64                    `protobuf:"varint,13,opt,name=all_start_nanos,json=allStartNanos" json:"all_start_nanos,omitempty"`
	OpStartRelNanos  int64                    `protobuf:"varint,14,opt,name=op_start_rel_nanos,json=opStartRelNanos" json:"op_start_rel_nanos,omitempty"`
	OpEndRelNanos    int64                    `protobuf:"varint,15,opt,name=op_end_rel_nanos,json=opEndRelNanos" json:"op_end_rel_nanos,omitempty"`
	AllEndRelNanos   int64                    `protobuf:"varint,16,opt,name=all_end_rel_nanos,json=allEndRelNanos" json:"all_end_rel_nanos,omitempty"`
	ScheduledNanos   int64                    `protobuf:"varint,17,opt,name=scheduled_nanos,json=scheduledNanos" json:"scheduled_nanos,omitempty"`
}
...
func (*NodeExecStats) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{4} }
...
type DeviceStepStats struct {
	...
	ThreadNames map[uint32]string `protobuf:"bytes,3,rep,name=thread_names,json=threadNames" json:"thread_names,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*DeviceStepStats) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{5} }
...
func (*StepStats) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{6} }
